...
class UploadHandler
{
    ...
    public function __construct ($options = null, $initialize = true, $error_messages = null)
    {
        ...
        $this->options = array(
            ...
            'upload_dir' => $_SERVER['DOCUMENT_ROOT'] . "/FormBuilder/public/uploaded_files/",
        ...
        if ( $this->validate ($uploaded_file, $file, $error, $index) )
        {
            ...
            if ( $uploaded_file && is_uploaded_file ($uploaded_file) )
            {
                ...
                else
                {
                    ...
                    $folderId = (new \AppFolder())->createFromPath ($file_path);
                    ...
                    // update version
                    (new DocumentVersion())->create ($arrParameters, $objUser);
                }
            }
            else
            {
